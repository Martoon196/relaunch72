...
### You already know it's not the work. It's the marketing.

That was the whole point of the autopsy — to stop guessing and see it in black and white. And now you have. The leaks are named, graded, and sitting in front of you. No more "something feels off." You know exactly what's off, and roughly what it's costing you.

So the only question left is the one you bought the autopsy to answer: **fix it, or keep paying for it?**

---

### What the autopsy diagnosed, the relaunch rebuilds

Your autopsy was the X-ray. The relaunch is the treatment — and it doesn't patch one leak, it rebuilds the whole marketing department around the business you've already built.

Everything a marketing department would hand you, rebuilt from your real answers, human signed-off, delivered in 72 hours:

- **Marketing audit and scorecard** — the full version of what your autopsy started
- **Dream buyer profile** — the exact customer who pays you best, in detail
- **Core message and voice guide** — how to say it, in your customers' words, not a template
- **Offer architecture** — how to package and price so choosing you is the obvious move
- **90-day growth plan** — sized to the hours you actually have
- **Website copy pack** — home, about and sales page, written to convert, ready to paste
- **12 ready-to-send emails** — a 7-email welcome series and a 5-email promotion
- **30 days of social content** — hooks, captions, CTAs, for the platforms your customers are actually on
- **One-page business plan** — the whole thing summarised, bank-and-partner ready

Nine deliverables. Every leak your autopsy found, closed.
...
**It ships in 72 hours** of your accepted intake. If we're late, your revision round becomes unlimited until you're happy, on us.

**It doesn't read generic** — that's the whole reason you're here, so that's the one we stake the money on. If the hero assets read generic after your included revision round, a strategist rewrites them by hand. If you still think they read generic after that, you keep the audit and the scorecard, and we refund the rest.

You've already seen the quality of our thinking on your business — that's what the autopsy was. This is the same thinking, applied to the whole department, signed off by a human before you see it.
...
**I already answered questions for the autopsy — do I start over?**
No. Your autopsy intake carries straight into the relaunch and gives us a head start. You'll add depth on a few areas the full build needs, but you're topping up, not starting again.

**What if the relaunch reads generic like the AI stuff I've seen?**
Then it gets rewritten by hand — that's the guarantee above, in writing. And you've already seen it doesn't: the autopsy was a sample of exactly the thinking that goes into the full build.
...
## AUDIT (copywriter rubric)

**Angle:** most-aware / decision-stage — the autopsy already did the problem-agitation, so this page's job is purely to convert diagnosis into treatment. Lead is the credit-back economics, not the problem (they're past the problem).
