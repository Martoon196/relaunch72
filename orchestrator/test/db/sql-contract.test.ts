...
const migration19Url = new URL('../../src/db/migrations/0019_legacy_lead_import_foundation.sql', import.meta.url);
const migration20Url = new URL('../../src/db/migrations/0020_legacy_lead_journey_board_materialization.sql', import.meta.url);
...
const migration50Url = new URL('../../src/db/migrations/0050_property_predator_mailgun_inbound_reply.sql', import.meta.url);
const migration51Url = new URL('../../src/db/migrations/0051_property_predator_campaign_machine.sql', import.meta.url);
...
const migration57Url = new URL('../../src/db/migrations/0057_property_predator_live_channel_emergency_pause.sql', import.meta.url);
const migration58Url = new URL('../../src/db/migrations/0058_property_predator_whatsapp_activation_readiness.sql', import.meta.url);
const migration59Url = new URL('../../src/db/migrations/0059_property_predator_owned_social_activation_readiness.sql', import.meta.url);
...
const migration68Url = new URL('../../src/db/migrations/0068_founder_pilot_preparation_approval_state_repair.sql', import.meta.url);
const migration69Url = new URL('../../src/db/migrations/0069_founder_pilot_preparation_trigger_capture_repair.sql', import.meta.url);
const migration70Url = new URL('../../src/db/migrations/0070_founder_pilot_evidence_runtime_contract_repair.sql', import.meta.url);
const migration71Url = new URL('../../src/db/migrations/0071_founder_pilot_evidence_startup_identity_repair.sql', import.meta.url);
const migration72Url = new URL('../../src/db/migrations/0072_founder_mailgun_inbound_sender_binding_repair.sql', import.meta.url);
...
const migration97Url = new URL('../../src/db/migrations/0097_property_predator_zernio_calendar_safe_cutover.sql', import.meta.url);
const migration98Url = new URL('../../src/db/migrations/0098_zernio_messaging_provider_account_binding.sql', import.meta.url);
...
test('bundled migration discovery orders and checksums through generated draft adapter session lock', async () => {
  const migrations = await discoverMigrations();
  const tail = migrations.slice(-94);
  assert.deepEqual(tail.map(({ filename, version }) => ({ filename, version })), [
    ...
    { filename: '0019_legacy_lead_import_foundation.sql', version: 19 },
    { filename: '0020_legacy_lead_journey_board_materialization.sql', version: 20 },
    ...
    { filename: '0050_property_predator_mailgun_inbound_reply.sql', version: 50 },
    { filename: '0051_property_predator_campaign_machine.sql', version: 51 },
    ...
    { filename: '0057_property_predator_live_channel_emergency_pause.sql', version: 57 },
    { filename: '0058_property_predator_whatsapp_activation_readiness.sql', version: 58 },
    { filename: '0059_property_predator_owned_social_activation_readiness.sql', version: 59 },
    ...
    { filename: '0068_founder_pilot_preparation_approval_state_repair.sql', version: 68 },
    { filename: '0069_founder_pilot_preparation_trigger_capture_repair.sql', version: 69 },
    { filename: '0070_founder_pilot_evidence_runtime_contract_repair.sql', version: 70 },
    { filename: '0071_founder_pilot_evidence_startup_identity_repair.sql', version: 71 },
    { filename: '0072_founder_mailgun_inbound_sender_binding_repair.sql', version: 72 },
    ...
    { filename: '0097_property_predator_zernio_calendar_safe_cutover.sql', version: 97 },
    { filename: '0098_zernio_messaging_provider_account_binding.sql', version: 98 },
  ...
  const sources = [
    ...
    (await readFile(migration19Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration20Url, 'utf8')).replace(/\r\n?/g, '\n'),
    ...
    (await readFile(migration50Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration51Url, 'utf8')).replace(/\r\n?/g, '\n'),
    ...
    (await readFile(migration57Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration58Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration59Url, 'utf8')).replace(/\r\n?/g, '\n'),
    ...
    (await readFile(migration68Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration69Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration70Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration71Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration72Url, 'utf8')).replace(/\r\n?/g, '\n'),
    ...
    (await readFile(migration97Url, 'utf8')).replace(/\r\n?/g, '\n'),
    (await readFile(migration98Url, 'utf8')).replace(/\r\n?/g, '\n'),
  ...
  assert.equal(sources.length, tail.length);
