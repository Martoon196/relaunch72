...
export const CORE_PLATFORM_MODULES: readonly PlatformModuleManifest[] = Object.freeze([
  ...
  { id: 'journeys', label: 'Conversion journeys', shortLabel: 'Journeys', description: 'Versioned milestones, explainable lead scores and auditable conversion facts.', icon: 'workflow', group: 'work', order: 25, route: '/portal/journeys', stage: 'available', requiredCapabilities: ['journeys.read'], dependsOn: ['crm'] },
