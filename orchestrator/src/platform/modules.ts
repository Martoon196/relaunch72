...
export const CORE_PLATFORM_MODULES: readonly PlatformModuleManifest[] = Object.freeze([
  ...
  { id: 'crm', label: 'CRM', shortLabel: 'CRM', description: 'Private contacts, opportunities, tasks and recorded CRM activity.', icon: 'users', group: 'work', order: 20, route: '/portal/crm/contacts', stage: 'available', requiredCapabilities: ['crm.contacts.read', 'crm.pipeline.read'], dependsOn: ['overview'] },
