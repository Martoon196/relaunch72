...
export const CORE_PLATFORM_MODULES: readonly PlatformModuleManifest[] = Object.freeze([
  ...
  { id: 'crm', label: 'CRM', shortLabel: 'CRM', description: 'Read-only contacts and pipeline snapshot for this workspace.', icon: 'users', group: 'work', order: 20, route: '/portal#crm', stage: 'preview', requiredCapabilities: ['crm.contacts.read', 'crm.pipeline.read'], dependsOn: ['overview'] },
