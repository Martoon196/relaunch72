import {
  ...
  isCampaignWizardGenerateReviewDraftActionReady,
  type CampaignWizardCreateAction,
  type CampaignWizardGenerateReviewDraftAction,
...
} from '../company-content-adapter/property-predator-marketing-draft-plan.js';
...
const CAMPAIGN_WIZARD_STYLE = `
  ...
  .cwiz-brain{display:grid;grid-template-columns:minmax(250px,.34fr) minmax(0,1fr);margin:18px;border:1px solid var(--w-line);background:linear-gradient(135deg,#101719,#090d0f)}.cwiz-brain-control{display:grid;align-content:start;gap:12px;padding:17px;border-right:1px solid var(--w-line)}.cwiz-brain-control h2,.cwiz-brain-route h2{margin:0;font-size:16px}.cwiz-brain-control p,.cwiz-brain-route p{margin:0;color:var(--w-muted);font-size:11px;line-height:1.55}.cwiz-brain-select{display:grid;gap:6px;color:var(--w-faint);font-size:10px;font-weight:850}.cwiz-brain-select select{min-height:44px;border:1px solid var(--w-line2);border-radius:7px;background:#070a0c;color:var(--w-ink);padding:8px 10px}.cwiz-brain-apply{min-height:42px;border:1px solid var(--w-teal);border-radius:7px;background:transparent;color:var(--w-teal);font-size:11px;font-weight:900;cursor:pointer}.cwiz-brain-route{display:grid;gap:14px;padding:17px}.cwiz-brain-top{display:flex;justify-content:space-between;gap:14px;align-items:flex-start}.cwiz-brain-state{flex:0 0 auto;border:1px solid #705d32;background:#171308;color:var(--w-amber);padding:5px 8px;font:850 9px var(--mono,monospace);letter-spacing:.05em;text-transform:uppercase}.cwiz-brain-state.ready{border-color:#33756d;background:#091b19;color:var(--w-teal)}.cwiz-brain-stage{border-left:3px solid var(--w-teal);background:#091311;padding:11px 13px}.cwiz-brain-stage strong{display:block;font-size:13px}.cwiz-brain-stage span{display:block;margin-top:4px;color:var(--w-muted);font-size:11px;line-height:1.5}.cwiz-brain-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.cwiz-brain-card{border:1px solid var(--w-line);background:#0a0f11;padding:12px}.cwiz-brain-card h3{margin:0 0 8px;font-size:11px}.cwiz-brain-list{display:grid;gap:7px;margin:0;padding:0;list-style:none}.cwiz-brain-list li{color:var(--w-muted);font-size:10px;line-height:1.45}.cwiz-brain-list strong{display:block;color:var(--w-ink);font-size:10px}.cwiz-brain-list code{color:var(--w-faint);font:750 9px var(--mono,monospace)}.cwiz-brain-list .blocked{color:var(--w-amber)}.cwiz-brain-proof{display:flex;flex-wrap:wrap;gap:7px}.cwiz-brain-proof span{border:1px solid var(--w-line);background:#080b0d;padding:5px 7px;color:var(--w-faint);font:750 9px var(--mono,monospace)}.cwiz-brain-boundary{border-top:1px solid var(--w-line);padding-top:10px;color:var(--w-faint);font-size:10px;line-height:1.5}
  .cwiz-generate{display:grid;gap:13px;border:1px solid #34756e;background:#071916;padding:14px}.cwiz-generate-head{display:flex;justify-content:space-between;gap:14px;align-items:start}.cwiz-generate-head h3{margin:0;font-size:14px}.cwiz-generate-head p{margin:4px 0 0;color:var(--w-muted);font-size:10px;line-height:1.5}.cwiz-generate-badge{border:1px solid var(--w-teal);padding:5px 7px;color:var(--w-teal);font:850 9px var(--mono,monospace);white-space:nowrap}.cwiz-generate-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.cwiz-generate-options{display:grid;gap:6px}.cwiz-generate-options>strong{font-size:10px}.cwiz-generate-option{display:grid;grid-template-columns:18px minmax(0,1fr);gap:7px;align-items:start;border:1px solid var(--w-line);background:#090e10;padding:8px;color:var(--w-muted);font-size:9px;line-height:1.4}.cwiz-generate-option input{width:16px;height:16px;margin:0;accent-color:var(--w-teal)}.cwiz-generate-option strong{display:block;color:var(--w-ink);font-size:10px}.cwiz-generate-submit{min-height:46px;border:1px solid var(--w-teal);border-radius:7px;background:var(--w-teal);color:#03110f;font-size:11px;font-weight:950;cursor:pointer}.cwiz-generate-confirm{display:grid;grid-template-columns:18px minmax(0,1fr);gap:7px;color:var(--w-muted);font-size:10px;line-height:1.5}.cwiz-generate-confirm input{width:16px;height:16px;margin:0;accent-color:var(--w-teal)}
  ...
  @media(max-width:900px){.cwiz-form{grid-template-columns:1fr}.cwiz-main{border-right:0}.cwiz-review{position:static;border-top:1px solid var(--w-line)}.cwiz-hero{grid-template-columns:1fr}.cwiz-option-list{grid-template-columns:1fr 1fr}.cwiz-brain{grid-template-columns:1fr}.cwiz-brain-control{border-right:0;border-bottom:1px solid var(--w-line)}}
  @media(max-width:580px){.cwiz-hero{padding:23px 18px}.cwiz-progress{grid-template-columns:1fr 1fr}.cwiz-progress li:nth-child(2){border-right:0}.cwiz-progress li:nth-child(n+3){border-top:1px solid var(--w-line)}.cwiz-main,.cwiz-review{padding:10px}.cwiz-two,.cwiz-option-list,.cwiz-brain-grid{grid-template-columns:1fr}.cwiz-step-body{padding:13px}.cwiz-review{top:auto}.cwiz-brain{margin:10px}.cwiz-brain-top{display:grid}}
...
export interface RenderCampaignWizardOptions {
  ...
  readonly draftGenerationAction?: CampaignWizardGenerateReviewDraftAction;
}
...
function generationForm(
  ...
  content: readonly CampaignWizardContentOptionView[],
  media: readonly CampaignWizardContentOptionView[],
  action: CampaignWizardGenerateReviewDraftAction | undefined,
): string {
  if (!isCampaignWizardGenerateReviewDraftActionReady(action)
      || plan.readiness !== 'draft_recipe_ready' || !plan.brandBrain || !plan.pack) return '';
  const facts = content.filter((item) =>
    item.eligible && item.brandSha256 === plan.brandBrain!.runtimeBrandSha256);
  const assets = media.filter((item) =>
    item.eligible && item.brandSha256 === plan.brandBrain!.runtimeBrandSha256);
  if (facts.length < 1 || assets.length < 1) return '';
  const factOptions = facts.map((item, index) => `<label class="cwiz-generate-option"><input type="radio" name="approved_fact_version_id" value="${escapeHtml(item.contentVersionId)}"${index === 0 ? ' checked' : ''} required><span><strong>${escapeHtml(item.title)}</strong>Immutable v${item.versionNumber.toLocaleString('en-GB')} · ${escapeHtml(item.shortHash)}…</span></label>`).join('');
  const assetOptions = assets.map((item, index) => `<label class="cwiz-generate-option"><input type="radio" name="approved_asset_version_id" value="${escapeHtml(item.contentVersionId)}"${index === 0 ? ' checked' : ''} required><span><strong>${escapeHtml(item.title)}</strong>Immutable v${item.versionNumber.toLocaleString('en-GB')} · ${escapeHtml(item.shortHash)}…</span></label>`).join('');
  return `<form class="cwiz-generate" method="post" action="${escapeHtml(action.actionUrl)}" data-campaign-review-draft-form data-channel-pack-form data-provider-effects="generation-only" data-outbound-effects="none">${hidden('_csrf', action.csrfToken)}${hidden('command_key', action.commandKey)}${hidden('expected_plan_sha256', plan.planSha256)}${hidden('laps', plan.selection.key)}${hidden('provider_effects', 'generation_only')}<div class="cwiz-generate-head"><div><h3>Turn one source into a channel pack</h3><p>Paste the source once. Property Predator's Brand Brain creates separate native drafts for every selected channel. Each version returns for human review and nothing is scheduled or published.</p></div><span class="cwiz-generate-badge">Up to ${action.maximumCostMinor.toLocaleString('en-GB')} per version</span></div><div class="cwiz-generate-grid"><div class="cwiz-generate-options"><strong>Channels</strong><label class="cwiz-generate-option"><input type="checkbox" name="platform" value="linkedin" checked><span><strong>LinkedIn</strong>Long-form authority and operator insight.</span></label><label class="cwiz-generate-option"><input type="checkbox" name="platform" value="facebook" checked><span><strong>Facebook</strong>Readable story and conversation prompt.</span></label><label class="cwiz-generate-option"><input type="checkbox" name="platform" value="instagram" checked><span><strong>Instagram</strong>Sharper caption with a visual-first hook.</span></label><label class="cwiz-generate-option"><input type="checkbox" name="platform" value="x" checked><span><strong>X</strong>Compressed claim, proof and response hook.</span></label></div><label class="cwiz-field">Tone<select name="tone" required><option value="direct and useful">Direct and useful</option><option value="educational and evidence-led">Educational and evidence-led</option><option value="challenging but credible">Challenging but credible</option></select><span>One voice; native structure per channel.</span></label></div><label class="cwiz-field">Source content<textarea name="topic" maxlength="20000" required placeholder="Paste the LinkedIn post, article, blog, transcript or campaign source here."></textarea><span>Up to 20,000 characters. Keep customer, lead and affiliate-private information out.</span></label><div class="cwiz-generate-grid"><div class="cwiz-generate-options"><strong>Exact approved fact version</strong>${factOptions}</div><div class="cwiz-generate-options"><strong>Exact approved asset version</strong>${assetOptions}</div></div><label class="cwiz-generate-confirm"><input type="checkbox" name="confirm_generation_only" value="confirmed" required><span>Create review drafts for the selected channels. I understand these versions remain unapproved and cannot send, schedule or publish.</span></label><button class="cwiz-generate-submit" type="submit">Create channel pack</button></form>`;
}

function draftRecipe(
  plan: PropertyPredatorMarketingDraftPlan | undefined,
  content: readonly CampaignWizardContentOptionView[],
  media: readonly CampaignWizardContentOptionView[],
  generationAction: CampaignWizardGenerateReviewDraftAction | undefined,
): string {
  if (!plan) return '';
  const options = PROPERTY_PREDATOR_MARKETING_LAPS_OPTIONS.map((entry) =>
    `<option value="${escapeHtml(entry.key)}"${entry.key === plan.selection.key ? ' selected' : ''}>${escapeHtml(entry.label)}</option>`).join('');
  const from = plan.selection.previousMilestoneName ?? 'Audience';
  const methods = plan.methods.map((method) =>
    `<li><strong>${escapeHtml(method.label)}</strong><code>${escapeHtml(method.contentSha256.slice(0, 12))}…</code></li>`).join('');
  const handoffs = plan.handoffs.map((handoff) =>
    `<li${handoff.status === 'optional-visual-blocked' ? ' class="blocked"' : ''}><strong>${handoff.sequence.toLocaleString('en-GB')} · ${escapeHtml(handoff.specialistLabel)}</strong>${escapeHtml(handoff.responsibility)}</li>`).join('');
  const blockers = plan.blockers.length > 0
    ? plan.blockers.map((blocker) => `<li class="blocked"><strong>${escapeHtml(blocker.code.replaceAll('_', ' '))}</strong>${escapeHtml(blocker.message)}</li>`).join('')
    : '<li><strong>Draft metadata ready</strong>The recipe is proven, but no model or provider can run from this surface.</li>';
  const packProof = plan.pack
    ? `Pack ${escapeHtml(plan.pack.packageSha256.slice(0, 12))}…`
    : 'Pack unavailable';
  const brainProof = plan.brandBrain
    ? `Brand ${escapeHtml(plan.brandBrain.runtimeBrandSha256.slice(0, 12))}…`
    : 'Brand release unavailable';
  const generate = generationForm(plan, content, media, generationAction);
  const callable = generate ? 'true' : 'false';
  const boundary = generate
    ? '<strong>Generation-only command connected.</strong> Exact approved evidence is re-read on submit. The returned source draft remains unapproved, unsendable, unschedulable and unpublishable.'
    : '<strong>Planning metadata only.</strong> Private training bodies are not loaded. No model is called, nothing is persisted by the campaign command, and provider effects remain NONE.';
  return `<section class="cwiz-brain" aria-labelledby="cwiz-brain-title" data-marketing-draft-preflight data-callable="${callable}" data-persisted="false" data-provider-effects="${generate ? 'generation-only' : 'none'}"><form class="cwiz-brain-control" method="get" action="${CAMPAIGN_WIZARD_ROUTE}"><span class="cwiz-kicker">Marketing command preflight</span><h2 id="cwiz-brain-title">Pick the conversion move</h2><p>Choose the canonical Property Predator journey milestone. Growth HQ recalculates the exact registered plan before any generation.</p><label class="cwiz-brain-select">Journey and target milestone<select name="laps">${options}</select></label><button class="cwiz-brain-apply" type="submit">Refresh draft recipe</button></form><div class="cwiz-brain-route"><div class="cwiz-brain-top"><div><span class="cwiz-kicker">LAPS route · ${escapeHtml(plan.selection.journeyName)}</span><h2>${escapeHtml(from)} → ${escapeHtml(plan.selection.targetMilestoneName)}</h2></div><span class="cwiz-brain-state${plan.readiness === 'draft_recipe_ready' ? ' ready' : ''}">${plan.readiness === 'draft_recipe_ready' ? 'Draft recipe ready' : 'Draft recipe blocked'}</span></div><div class="cwiz-brain-stage"><strong>${escapeHtml(plan.selection.marketingJob)}</strong><span>Canonical journey v${plan.selection.journeyVersion.toLocaleString('en-GB')} · ${escapeHtml(plan.selection.journeyDefinitionSha256.slice(0, 12))}…</span></div><div class="cwiz-brain-grid"><section class="cwiz-brain-card"><h3>Adapted internal methods</h3><ul class="cwiz-brain-list">${methods}</ul></section><section class="cwiz-brain-card"><h3>Specialist handoff order</h3><ol class="cwiz-brain-list">${handoffs}</ol></section><section class="cwiz-brain-card"><h3>Why anything is blocked</h3><ul class="cwiz-brain-list">${blockers}</ul></section><section class="cwiz-brain-card"><h3>Immutable provenance</h3><div class="cwiz-brain-proof"><span>${packProof}</span><span>${brainProof}</span><span>Plan ${escapeHtml(plan.planSha256.slice(0, 12))}…</span></div></section></div>${generate}<div class="cwiz-brain-boundary">${boundary}</div></div></section>`;
}
