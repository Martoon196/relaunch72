...
export function createPropertyPredatorPublicSocialCampaignsFixture(): readonly SocialCampaignCommandProjection[] {
  return Object.freeze([
    ...
    Object.freeze({
      ...
      state: 'simulated_reconciled' as const,
      simulationAttemptCount: 2,
      reconciliationAttemptCount: 1,
      testReferenceSha256: 'e3'.repeat(32),
    }),
    Object.freeze({
      ...BASE,
    ...
    Object.freeze({
      ...
      planSha256: 'c4'.repeat(32),
      scheduledFor: '2026-08-29T13:00:00.000Z',
      operationId: 'a6000000-0000-4000-8000-000000000004',
      targetId: 'a7000000-0000-4000-8000-000000000004',
      network: 'x' as const,
      targetLabel: 'X source-revalidation TEST rail',
