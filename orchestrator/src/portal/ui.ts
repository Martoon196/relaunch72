...
export const PORTAL_STYLE = `
  ...
  *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--canvas);color:var(--ink);font-family:var(--sans);line-height:1.5;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}
  ...
  .brand-lockup{display:flex;align-items:center;gap:10px;padding:4px 10px 18px}.brand-mark{width:34px;height:34px;border-radius:10px;display:grid;place-items:center;background:linear-gradient(145deg,#ffc568,var(--accent));color:#161b25;font-family:var(--mono);font-weight:900;font-size:0.875rem;box-shadow:0 7px 20px rgba(237,156,36,.2)}
  .brand-name{font-size:0.875rem;font-weight:850;letter-spacing:.075em}.brand-name small{display:block;color:var(--nav-muted);font-size:0.875rem;font-weight:650;letter-spacing:.08em;text-transform:uppercase;margin-top:1px}
  .workspace-menu{margin:0 2px 18px;position:relative}.workspace-menu summary{list-style:none;cursor:pointer;border:1px solid var(--nav-line);border-radius:12px;background:var(--nav-raised);padding:10px;display:grid;grid-template-columns:34px 1fr 16px;align-items:center;gap:9px}.workspace-menu summary::-webkit-details-marker{display:none}.workspace-menu[open] summary{border-color:#56647a}.workspace-avatar{width:34px;height:34px;border-radius:9px;background:#283b54;display:grid;place-items:center;font-weight:800;color:#dbe7f5}.workspace-copy{min-width:0}.workspace-copy strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:0.875rem}.workspace-copy small{display:block;color:var(--nav-muted);font-size:0.875rem;margin-top:1px}.workspace-menu summary .chev{color:var(--nav-muted);width:14px;transition:transform .18s ease}.workspace-menu[open] summary .chev{transform:rotate(90deg)}
  .workspace-popover{position:absolute;z-index:30;top:calc(100% + 7px);left:0;right:0;background:#fff;color:var(--ink);border:1px solid var(--line);border-radius:12px;padding:8px;box-shadow:var(--shadow-lg)}.workspace-current{display:flex;align-items:center;gap:9px;padding:8px;border-radius:8px;background:var(--panel-subtle);font-size:0.875rem;font-weight:750}.workspace-popover p{margin:7px 6px 3px;color:var(--muted);font-size:0.875rem;line-height:1.4}
  .nav-label{color:#6f8097;font-family:var(--mono);font-size:0.875rem;font-weight:750;letter-spacing:.11em;text-transform:uppercase;margin:15px 11px 7px}.primary-nav{display:flex;flex-direction:column;gap:3px;min-height:0;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#37465d transparent}.nav-item{width:100%;min-height:40px;border:0;border-radius:10px;display:flex;align-items:center;gap:11px;padding:9px 10px;background:transparent;color:var(--nav-muted);font-size:0.875rem;font-weight:650;text-align:left}.nav-item:hover{background:rgba(255,255,255,.055);color:#fff}.nav-item[aria-current="page"]{color:#fff;background:rgba(237,156,36,.13);box-shadow:inset 3px 0 var(--accent)}.nav-item[aria-current="page"] .icon{color:var(--accent)}.nav-locked{cursor:not-allowed;color:#748398}.nav-locked:hover{color:#8796aa;background:rgba(255,255,255,.025)}.module-state{margin-left:auto;display:inline-flex;align-items:center;gap:4px;color:#77879c;font-family:var(--mono);font-size:0.875rem;letter-spacing:.04em;text-transform:uppercase}.module-state .icon{width:11px;height:11px}.sidebar-foot{margin-top:auto;border-top:1px solid var(--nav-line);padding:13px 5px 2px}.sandbox-note{display:flex;gap:9px;align-items:flex-start;color:var(--nav-muted);font-size:0.875rem;line-height:1.4;padding:5px}.sandbox-dot{width:7px;height:7px;border-radius:50%;background:var(--accent);box-shadow:0 0 0 4px rgba(237,156,36,.1);margin:5px 2px 0;flex:0 0 auto}.sandbox-note strong{display:block;color:#d8e0eb;font-size:0.875rem;margin-bottom:1px}

  .workspace{min-height:100vh;margin-left:264px}.topbar{height:70px;position:sticky;top:0;z-index:15;background:color-mix(in srgb,var(--canvas) 90%,transparent);backdrop-filter:blur(14px);border-bottom:1px solid var(--line);display:flex;align-items:center;justify-content:space-between;padding:0 34px;gap:16px}.mobile-brand{display:none}.top-actions{display:flex;align-items:center;gap:9px}.theme-picker{display:flex;align-items:center;gap:7px}.theme-picker label{font-size:0.875rem;color:var(--muted);font-weight:700}.theme-picker select{height:38px;border:1px solid var(--line);border-radius:10px;background:var(--panel);color:var(--ink);padding:0 28px 0 10px;font:700 0.875rem var(--sans)}.top-icon-button{width:38px;height:38px;border:1px solid var(--line);border-radius:11px;background:var(--panel);display:grid;place-items:center;cursor:pointer}.top-icon-button:hover{border-color:var(--line-strong);background:var(--panel-subtle)}
  .quick-menu{position:relative;width:min(420px,42vw)}.quick-menu summary{list-style:none;cursor:pointer;height:40px;border:1px solid var(--line);border-radius:11px;background:var(--panel);display:flex;align-items:center;gap:10px;color:var(--muted);padding:0 11px;box-shadow:var(--shadow-sm)}.quick-menu summary::-webkit-details-marker{display:none}.quick-menu summary:hover{border-color:var(--line-strong)}.quick-menu summary span{font-size:0.875rem}.quick-menu summary kbd{margin-left:auto;border:1px solid var(--line);border-bottom-color:var(--line-strong);border-radius:6px;background:var(--panel-subtle);padding:2px 7px;font:600 0.875rem var(--mono);color:var(--faint)}.command-popover{position:absolute;z-index:40;top:calc(100% + 8px);left:0;width:min(480px,calc(100vw - 36px));background:var(--panel);border:1px solid var(--line);border-radius:14px;padding:9px;box-shadow:var(--shadow-lg)}.command-title{font:750 0.875rem var(--mono);letter-spacing:.09em;text-transform:uppercase;color:var(--faint);padding:7px 9px 5px}.command-link{display:flex;align-items:center;gap:10px;padding:9px;border-radius:9px;font-size:0.875rem;font-weight:650}.command-link:hover{background:var(--panel-subtle)}.command-link small{margin-left:auto;color:var(--faint);font:650 0.875rem var(--mono)}.command-link.locked{color:var(--muted);cursor:not-allowed}.command-link.locked small{display:flex;align-items:center;gap:4px;text-transform:uppercase}.command-link.locked .icon:last-child{width:11px;height:11px}
  .main{max-width:1420px;margin:0 auto;padding:32px 34px 78px}.page-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;margin-bottom:25px}.eyebrow{display:flex;align-items:center;gap:7px;margin-bottom:8px;color:var(--accent-deep);font:750 0.875rem var(--mono);letter-spacing:.095em;text-transform:uppercase}.eyebrow .icon{width:14px;height:14px}.page-heading h1{font-size:clamp(1.65rem,2.4vw,2.25rem);line-height:1.14;letter-spacing:-.035em;margin:0}.page-heading p{max-width:700px;color:var(--muted);font-size:0.91rem;margin:8px 0 0}.page-heading-actions{display:flex;align-items:center;gap:9px;flex:0 0 auto}
  .button{appearance:none;border:1px solid transparent;border-radius:11px;min-height:42px;padding:9px 15px;display:inline-flex;align-items:center;justify-content:center;gap:8px;background:var(--accent);color:#1b2028;font-weight:800;font-size:0.875rem;cursor:pointer;box-shadow:0 5px 15px rgba(237,156,36,.16)}.button:hover{background:#f3a832;transform:translateY(-1px)}.button:active{transform:translateY(0)}.button.secondary{background:var(--panel);color:var(--ink);border-color:var(--line);box-shadow:var(--shadow-sm);font-weight:700}.button.secondary:hover{background:var(--panel-subtle);border-color:var(--line-strong)}.button.compact{min-height:36px;padding:7px 11px;font-size:0.875rem}.button .icon{width:16px;height:16px}.run-helper{color:var(--faint);font-size:0.875rem;margin-top:7px;text-align:right}
  .status-badge,.pill{display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:4px 8px;font:750 0.875rem var(--mono);letter-spacing:.055em;text-transform:uppercase}.status-badge{background:var(--accent-soft);color:var(--accent-deep);border:1px solid #f3d6a7}.status-badge .dot{width:6px;height:6px;border-radius:50%;background:var(--accent)}.pill{background:var(--panel-strong);color:var(--muted);border:1px solid var(--line)}.pill.draft{background:var(--info-soft);border-color:#cbddf9;color:var(--info)}.pill.paused{background:var(--accent-soft);border-color:#efd5ab;color:var(--accent-deep)}.pill.ok{background:var(--success-soft);border-color:#bee7d8;color:var(--success)}
  .metric-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:13px;margin-bottom:24px}.metric{background:var(--panel);border:1px solid var(--line);border-radius:var(--radius);padding:17px 18px;box-shadow:var(--shadow-sm)}.metric-head{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:13px}.metric-icon{width:31px;height:31px;border-radius:9px;display:grid;place-items:center;background:var(--panel-strong);color:var(--muted)}.metric-icon .icon{width:16px;height:16px}.metric .n{font:800 1.65rem/1 var(--mono);letter-spacing:-.04em;font-variant-numeric:tabular-nums}.metric .l{color:var(--muted);font-size:0.875rem;margin-top:7px}.metric-context{font-size:0.875rem;color:var(--faint)}
  .dashboard-grid{display:grid;grid-template-columns:minmax(0,1.75fr) minmax(280px,.75fr);gap:18px;align-items:start}.stack{display:grid;gap:18px}.panel{background:var(--panel);border:1px solid var(--line);border-radius:var(--radius);box-shadow:var(--shadow-sm);overflow:hidden}.panel-head{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;padding:18px 19px 14px}.panel-title-wrap{min-width:0}.panel h2,.panel h3{font-size:0.91rem;letter-spacing:-.01em;margin:0}.panel-subtitle{font-size:0.875rem;color:var(--muted);margin:4px 0 0}.panel-body{padding:0 19px 19px}.panel-divider{border-top:1px solid var(--line)}
  .pipeline{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px}.stage{position:relative;min-height:91px;background:var(--panel-subtle);border:1px solid var(--line);border-radius:11px;padding:12px;overflow:hidden}.stage::after{content:"";position:absolute;inset:auto 0 0;height:3px;background:var(--stage-color,var(--faint));opacity:.75}.stage .c{font:800 1.35rem/1.1 var(--mono);font-variant-numeric:tabular-nums}.stage .l{font-size:0.875rem;color:var(--muted);text-transform:capitalize;margin-top:8px}.stage .share{font-size:0.875rem;color:var(--faint);margin-top:3px}.stage-won{--stage-color:var(--success)}.stage-lost{--stage-color:var(--danger)}.stage-qualified{--stage-color:var(--accent)}.stage-contacted{--stage-color:var(--info)}
  .content-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.draft-card{border:1px solid var(--line);border-radius:12px;background:var(--panel-subtle);padding:15px;min-width:0}.draft-card.wide{grid-column:1/-1}.draft-meta{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:11px}.draft-label{font:750 0.875rem var(--mono);letter-spacing:.07em;text-transform:uppercase;color:var(--faint)}.draft-card h4{font-size:0.875rem;line-height:1.4;margin:0 0 7px}.draft-card p{font-size:0.875rem;color:var(--muted);line-height:1.55;margin:0}.draft-card .hook{color:var(--ink);font-weight:740;font-size:0.875rem;margin-bottom:5px}.draft-list{list-style:none;padding:0;margin:0}.draft-list li{display:grid;grid-template-columns:64px 1fr;gap:10px;padding:10px 0;border-top:1px solid var(--line);font-size:0.875rem}.draft-list li:first-child{border-top:0;padding-top:1px}.draft-role{font:700 0.875rem var(--mono);letter-spacing:.04em;text-transform:uppercase;color:var(--faint)}
  .keyword-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;padding:9px 0;border-top:1px solid var(--line);font-size:0.875rem}.keyword-row:first-child{border-top:0}.keyword-row .volume{font:750 0.875rem var(--mono);color:var(--accent-deep)}.ad-headlines{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:10px}.ad-headlines span{border:1px solid var(--line);border-radius:7px;padding:4px 7px;background:var(--panel);font-size:0.875rem;color:var(--ink)}
  .data-table{width:100%;border-collapse:collapse;font-size:0.875rem}.data-table th{text-align:left;color:var(--faint);font:750 0.875rem var(--mono);letter-spacing:.07em;text-transform:uppercase;padding:10px 8px;border-bottom:1px solid var(--line)}.data-table td{padding:12px 8px;border-bottom:1px solid var(--line);vertical-align:middle}.data-table tbody tr:last-child td{border-bottom:0}.contact-name{font-weight:720}.contact-reach{font-family:var(--mono);font-size:0.875rem;color:var(--muted);word-break:break-word}.stage-badge{display:inline-flex;justify-self:start;border:1px solid var(--line);background:var(--panel-subtle);border-radius:999px;padding:3px 8px;font:700 0.875rem var(--mono);text-transform:capitalize;color:var(--muted)}
  .timeline{position:relative}.event{display:grid;grid-template-columns:28px 1fr;gap:10px;padding:9px 0}.event:not(:last-child){border-bottom:1px solid var(--line)}.event-icon{width:27px;height:27px;border-radius:8px;background:var(--panel-strong);color:var(--muted);display:grid;place-items:center;font:800 0.875rem var(--mono)}.event-icon.run{background:var(--accent-soft);color:var(--accent-deep)}.event-summary{font-size:0.875rem;line-height:1.45}.event-time{font:600 0.875rem var(--mono);color:var(--faint);margin-top:3px}.brand-quote{border-left:3px solid var(--accent);padding-left:12px;color:var(--muted);font-size:0.875rem;line-height:1.55;margin:2px 0 14px}.pillar{display:grid;grid-template-columns:19px 1fr;gap:7px;align-items:start;padding:6px 0;font-size:0.875rem}.pillar-index{color:var(--accent-deep);font:800 0.875rem var(--mono)}
  .empty-state{border:1px dashed var(--line-strong);border-radius:12px;background:var(--panel-subtle);padding:22px;text-align:center;color:var(--muted)}.empty-icon{width:36px;height:36px;margin:0 auto 9px;border-radius:10px;background:var(--panel-strong);display:grid;place-items:center;color:var(--faint)}.empty-state strong{display:block;color:var(--ink);font-size:0.875rem;margin-bottom:4px}.empty-state p{max-width:420px;margin:0 auto;font-size:0.875rem;line-height:1.5}
  .plan-card-inline{display:flex;align-items:center;justify-content:space-between;gap:12px}.plan-name{font-size:0.875rem;font-weight:740}.status{display:inline-flex;align-items:center;gap:6px;border:1px solid var(--line);border-radius:999px;padding:4px 8px;font:750 0.875rem var(--mono);letter-spacing:.04em;text-transform:uppercase;color:var(--muted)}.status .dot{width:6px;height:6px;border-radius:50%;background:var(--faint)}.status.ok{color:var(--success);border-color:#a9dcca;background:var(--success-soft)}.status.ok .dot{background:var(--success)}.status.warn{color:var(--accent-deep);border-color:#ecd09f;background:var(--accent-soft)}.status.warn .dot{background:var(--accent)}.billing-link{display:inline-flex;align-items:center;gap:4px;margin-top:13px;color:var(--accent-deep);font-size:0.875rem;font-weight:760}.billing-link .icon{width:12px;height:12px}
  .module-preview{margin-top:24px}.module-preview-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:9px}.module-card{min-height:105px;border:1px solid var(--line);border-radius:13px;background:linear-gradient(145deg,var(--panel),var(--panel-subtle));padding:13px;color:var(--muted)}.module-card-top{display:flex;align-items:center;justify-content:space-between;gap:7px}.module-card .icon{color:var(--faint)}.module-card h3{font-size:0.875rem;margin:13px 0 3px;color:var(--ink)}.module-card p{font-size:0.875rem;line-height:1.4;margin:0}.lock-label{display:inline-flex;align-items:center;gap:3px;color:var(--faint);font:700 0.875rem var(--mono);text-transform:uppercase}.lock-label .icon{width:10px;height:10px}
  .notice{display:flex;align-items:flex-start;gap:10px;border:1px solid #efd09a;background:var(--accent-soft);color:#71430d;border-radius:12px;padding:12px 14px;margin-bottom:18px;font-size:0.875rem}.notice .icon{width:16px;height:16px;margin-top:1px;flex:0 0 auto}.billing-summary{display:flex;align-items:center;justify-content:space-between;gap:20px;flex-wrap:wrap}.billing-summary h2{font-size:1.06rem;margin:0}.billing-summary p{font-size:0.875rem;color:var(--muted);margin:4px 0 0}.billing-actions{display:flex;align-items:center;gap:9px}.plans{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:13px}.plan{border:1px solid var(--line);border-radius:14px;background:var(--panel-subtle);padding:17px;display:flex;flex-direction:column;min-height:220px}.plan.current{border-color:var(--accent);box-shadow:inset 0 0 0 1px var(--accent);background:var(--accent-soft)}.plan h3{font-size:0.88rem;margin:0}.plan-price{font:850 1.35rem var(--mono);letter-spacing:-.04em;color:var(--ink);margin:8px 0}.plan-description{color:var(--muted);font-size:0.875rem;line-height:1.55;flex:1;margin:0 0 14px}.current-plan-tag{color:var(--accent-deep);font:750 0.875rem var(--mono);letter-spacing:.04em;text-transform:uppercase}

  .auth-shell{min-height:100vh;display:grid;grid-template-columns:minmax(320px,.9fr) minmax(420px,1.1fr);background:var(--panel)}.auth-panel{display:grid;place-items:center;padding:44px 28px}.auth-card{width:100%;max-width:420px}.auth-brand{display:flex;align-items:center;gap:10px;margin-bottom:42px}.auth-brand .brand-mark{width:38px;height:38px}.auth-brand strong{letter-spacing:.08em;font-size:0.875rem}.auth-card h1{font-size:2rem;letter-spacing:-.04em;margin:0 0 8px}.auth-lead{color:var(--muted);font-size:0.88rem;margin-bottom:26px}.auth-sso{display:grid;gap:9px;margin-bottom:18px}.auth-provider-button{position:relative;width:100%;min-height:47px;background:#fff;font-size:0.875rem}.auth-provider-mark{position:absolute;left:13px;width:24px;height:24px;border-radius:8px;display:grid;place-items:center;font:800 0.875rem var(--sans)}.auth-provider-mark.google{color:#4285f4;background:#f4f7ff;border:1px solid #dbe5ff}.auth-provider-mark.predator{color:var(--accent);background:var(--nav)}.auth-divider{display:flex;align-items:center;gap:11px;color:var(--faint);font-size:0.875rem;margin:0 0 16px;text-transform:uppercase;letter-spacing:.07em}.auth-divider::before,.auth-divider::after{content:"";height:1px;background:var(--line);flex:1}.auth-divider span{white-space:nowrap}.field{margin-bottom:15px}.field label{display:block;color:var(--ink);font-size:0.875rem;font-weight:740;margin:0 0 6px}.field input{width:100%;height:45px;border:1px solid var(--line-strong);border-radius:11px;background:#fff;color:var(--ink);padding:0 12px;font-size:0.88rem}.field input:hover{border-color:#abb6c5}.field input:focus{border-color:var(--accent);box-shadow:0 0 0 4px rgba(237,156,36,.11)}.field input:focus-visible{outline:3px solid var(--accent);outline-offset:2px}.auth-button{width:100%;margin-top:7px}.auth-error{display:flex;gap:8px;border:1px solid #f0c0bd;background:var(--danger-soft);color:var(--danger);border-radius:10px;padding:10px 11px;font-size:0.875rem;margin-bottom:16px}.auth-error .icon{width:15px;height:15px}.auth-foot{color:var(--faint);font-size:0.875rem;text-align:center;margin:19px 0 0}.auth-story{position:relative;overflow:hidden;background:var(--nav);color:var(--nav-text);padding:8vh 7vw;display:flex;flex-direction:column;justify-content:center}.auth-story::before{content:"";position:absolute;width:520px;height:520px;right:-180px;top:-220px;border-radius:50%;background:radial-gradient(circle,rgba(237,156,36,.22),transparent 67%)}.auth-story-inner{position:relative;max-width:580px}.auth-kicker{color:var(--accent);font:750 0.875rem var(--mono);letter-spacing:.11em;text-transform:uppercase}.auth-story h2{font-size:clamp(2.2rem,4vw,4rem);line-height:1.02;letter-spacing:-.05em;margin:17px 0 21px}.auth-story p{max-width:500px;color:#aeb9c8;font-size:0.9rem;line-height:1.7}.auth-modules{display:flex;flex-wrap:wrap;gap:7px;margin-top:30px}.auth-modules span{border:1px solid var(--nav-line);background:rgba(255,255,255,.035);border-radius:999px;padding:6px 10px;color:#c7d0dc;font-size:0.875rem}.auth-modules .planned{color:#8290a4}
  .auth-sso-note{color:var(--faint);font-size:0.875rem;line-height:1.45;margin:1px 4px 0;text-align:center}
  ...
  @media(max-width:880px){.sidebar{display:none}.workspace{margin-left:0}.topbar{height:62px;padding:0 18px}.mobile-brand{display:flex;align-items:center;gap:8px}.mobile-brand .brand-mark{width:30px;height:30px;border-radius:8px;font-size:0.875rem}.mobile-brand strong{font-size:0.875rem;letter-spacing:.07em}.quick-menu{width:auto;margin-left:auto}.quick-menu summary{width:40px;padding:0;justify-content:center}.quick-menu summary span,.quick-menu summary kbd{display:none}.command-popover{position:fixed;top:70px;left:18px;right:18px;width:auto;max-height:calc(100vh - 90px);overflow:auto}.main{padding:25px 18px calc(102px + env(safe-area-inset-bottom))}.dashboard-grid{grid-template-columns:1fr}.module-preview-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.mobile-nav{display:grid;grid-template-columns:repeat(var(--mobile-nav-count),minmax(0,1fr));position:fixed;z-index:25;left:10px;right:10px;bottom:calc(10px + env(safe-area-inset-bottom));background:rgba(16,24,39,.96);backdrop-filter:blur(14px);border:1px solid var(--nav-line);border-radius:15px;padding:5px;box-shadow:0 18px 42px rgba(16,24,39,.28)}.mobile-nav a{display:flex;min-height:56px;flex-direction:column;align-items:center;justify-content:center;gap:3px;color:#9aa8bb;font-size:0.875rem;font-weight:700;border-radius:10px}.mobile-nav a[aria-current="page"],.mobile-nav a:active{color:#fff;background:rgba(237,156,36,.13)}.mobile-nav .icon{width:17px;height:17px}.auth-shell{grid-template-columns:1fr}.auth-story{display:none}}
  @media(max-width:520px){.topbar{padding-inline:10px;gap:7px}.mobile-brand strong,.top-actions>.status-badge,.theme-picker label{display:none}.top-actions{min-width:0;gap:6px}.theme-picker select{width:96px;padding-left:8px;padding-right:22px}.quick-menu{margin-left:auto}}
  @media(max-width:640px){html{scroll-padding-top:74px}.page-heading{display:block}.page-heading-actions{margin-top:17px}.page-heading-actions form,.page-heading-actions .button{width:100%}.run-helper{text-align:left}.metric-grid{gap:9px}.metric{padding:14px}.pipeline{grid-template-columns:repeat(2,minmax(0,1fr))}.pipeline .stage:last-child{grid-column:1/-1}.content-grid{grid-template-columns:1fr}.draft-card.wide{grid-column:auto}.module-preview-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.plans{grid-template-columns:1fr}.panel-head{padding:16px 15px 12px}.panel-body{padding:0 15px 15px}.data-table thead{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)}.data-table,.data-table tbody,.data-table tr,.data-table td{display:block;width:100%}.data-table tr{padding:10px 0;border-bottom:1px solid var(--line)}.data-table tr:last-child{border-bottom:0}.data-table td{display:grid;grid-template-columns:78px 1fr;gap:9px;border:0;padding:4px 0}.data-table td::before{content:attr(data-label);color:var(--faint);font:700 0.875rem var(--mono);letter-spacing:.05em;text-transform:uppercase}.auth-panel{padding:28px 20px}.auth-brand{margin-bottom:34px}}
...
function profileTheme(profile: PortalProductProfile): string {
  ...
  const predator = profile.id === 'property_predator_growth'
    ? `:root{color-scheme:dark;--accent-ink:#03110f;--sans:"Segoe UI",Arial,ui-sans-serif,system-ui,sans-serif;--mono:"IBM Plex Mono","SFMono-Regular",Consolas,monospace;--display:"Cormorant Garamond",Georgia,serif;--success:#22c55e;--success-soft:#10291d;--danger:#ef4444;--danger-soft:#321719;--info:#72a7ff;--info-soft:#121f34;--shadow-sm:none;--shadow-lg:none;--radius:14px;--radius-sm:10px}
      html[data-theme="light"]{color-scheme:light;--accent-ink:#ffffff;--canvas:#f4f7f6;--panel:#ffffff;--panel-subtle:#f7faf9;--panel-strong:#e9f0ee;--ink:#14201f;--muted:#536765;--faint:#536765;--line:#d8e2df;--line-strong:#b9cbc7;--accent:#087f72;--accent-deep:#05675d;--accent-soft:#dff5f1;--nav:#10201e;--nav-raised:#18302d;--nav-line:#294641;--nav-text:#f5fbfa;--nav-muted:#afc4c0;--success:#087653;--success-soft:#e2f5ed;--danger:#ad3038;--danger-soft:#fcebed;--info:#285fa7;--info-soft:#eaf1fb;--shadow-sm:0 1px 2px rgba(20,32,31,.05);--shadow-lg:0 18px 48px rgba(20,32,31,.16)}
      @media(prefers-color-scheme:light){html[data-theme="system"]{color-scheme:light;--accent-ink:#ffffff;--canvas:#f4f7f6;--panel:#ffffff;--panel-subtle:#f7faf9;--panel-strong:#e9f0ee;--ink:#14201f;--muted:#536765;--faint:#536765;--line:#d8e2df;--line-strong:#b9cbc7;--accent:#087f72;--accent-deep:#05675d;--accent-soft:#dff5f1;--nav:#10201e;--nav-raised:#18302d;--nav-line:#294641;--nav-text:#f5fbfa;--nav-muted:#afc4c0;--success:#087653;--success-soft:#e2f5ed;--danger:#ad3038;--danger-soft:#fcebed;--info:#285fa7;--info-soft:#eaf1fb;--shadow-sm:0 1px 2px rgba(20,32,31,.05);--shadow-lg:0 18px 48px rgba(20,32,31,.16)}}
      /* Shared HQ reading and input baseline, in every appearance mode. */
      html[data-theme] body{font-size:1rem;line-height:1.6}
      html[data-theme] :is(p,label,input,select,textarea,button,summary){font-size:1rem;line-height:1.5}
      html[data-theme] :is(small,code,time){font-size:.875rem;line-height:1.5}
      html[data-theme] input::placeholder,html[data-theme] textarea::placeholder{color:var(--muted);opacity:1}
      html[data-theme] .main :is(input,select,textarea){background:var(--panel);color:var(--ink);border-color:var(--line-strong)}
      .topbar{background:var(--panel);border-bottom-color:var(--line)}.sidebar{border-right-color:var(--line)}
      .brand-name{font-family:var(--display);font-size:1.06rem;font-weight:600;letter-spacing:-.01em}.brand-name .brand-accent{color:var(--accent)}.brand-name small{font-family:var(--mono);font-size:0.875rem;letter-spacing:.14em;margin-top:4px}
...
export function appShell(opts: AppShellOptions): string {
  ...
  <div class="app-shell">
    ...
    <div class="workspace">
      <header class="topbar">
        <a class="mobile-brand" href="/portal" aria-label="Workspace overview"><span class="brand-mark">${compactMark}</span><strong class="brand-name">${brandName}</strong></a>
