...
const CONTENT_CALENDAR_STYLE = `
  ...
  .ccal-media-preview[data-upload-state="uploading"]{border-color:#d5a642}.ccal-media-preview[data-upload-state="uploading"] p{color:#ffe09a}.ccal-media-preview[data-upload-state="ready"]{border-color:var(--cal-teal)}.ccal-media-preview[data-upload-state="ready"] p{color:var(--cal-teal)}.ccal-media-preview[data-upload-state="failed"]{border-color:#d95f67;background:#241113}.ccal-media-preview[data-upload-state="failed"] p{color:#ffb2b7}
