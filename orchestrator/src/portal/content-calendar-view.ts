...
const CONTENT_CALENDAR_STYLE = `
  ...
  .ccal-live-workflow{display:grid;gap:10px;margin:14px 0 0;padding:0;list-style:none;counter-reset:live-step}.ccal-live-workflow li{counter-increment:live-step;display:grid;grid-template-columns:30px minmax(0,1fr);gap:9px;align-items:start;color:var(--cal-muted);font-size:12px;line-height:1.45}.ccal-live-workflow li::before{content:counter(live-step);width:30px;height:30px;display:grid;place-items:center;border:1px solid #337a72;border-radius:50%;color:var(--cal-teal);font:900 11px var(--mono,monospace)}.ccal-live-workflow strong{display:block;color:var(--cal-ink);font-size:12px}.ccal-live-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:15px}.ccal-live-actions a{min-height:44px;display:inline-flex;align-items:center;border:1px solid #337a72;border-radius:7px;background:#08211e;color:var(--cal-teal);padding:0 13px;font-size:11px;font-weight:900}.ccal-live-actions a.secondary{border-color:var(--cal-line2);background:#101619;color:var(--cal-muted)}.ccal-live-boundary{margin:13px 0 0;border-left:3px solid var(--cal-teal);background:#071b19;padding:10px 12px;color:var(--cal-muted);font-size:11px;line-height:1.5}.ccal-live-boundary strong{color:var(--cal-teal)}.ccal-live-read-state{border:1px solid var(--cal-line2);background:#090d0f;padding:12px;color:var(--cal-muted);font-size:11px;line-height:1.5}.ccal-live-read-state.attention{border-color:#675b35;color:var(--cal-amber)}.ccal-live-networks{display:flex;gap:6px;flex-wrap:wrap;margin:0 0 10px}.ccal-live-network{border:1px solid #2d897e;border-radius:999px;background:var(--cal-teal-soft);color:var(--cal-teal);padding:4px 8px;font:800 10px var(--mono,monospace);text-transform:uppercase}
`;
