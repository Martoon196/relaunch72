...
export interface ContentCalendarLiveScheduleProjectionView {
  readonly status: 'ready' | 'unavailable';
  readonly configuredNetworks: readonly ('instagram' | 'linkedin')[];
  readonly items: readonly ContentCalendarLiveScheduleView[];
  readonly activation?: ContentCalendarCommandActionView;
}
...
const CONTENT_CALENDAR_STYLE = `
  ...
  .ccal-safety{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:13px;align-items:center;padding:11px 30px;border-bottom:1px solid var(--cal-line);background:var(--cal-panel)}.ccal-safety-mark{color:var(--cal-teal);font:900 14px var(--mono,monospace);letter-spacing:.08em;text-transform:uppercase}.ccal-safety p{margin:0;color:var(--cal-muted);font-size:14px;line-height:1.5}.ccal-safety p strong{color:var(--cal-ink)}.ccal-safety-badge{border:1px solid var(--cal-line2);padding:5px 8px;color:var(--cal-faint);font:850 14px var(--mono,monospace);letter-spacing:.06em;text-transform:uppercase;white-space:nowrap}
  .ccal-toolbar{display:grid;grid-template-columns:auto minmax(230px,1fr) auto;gap:13px;align-items:center;padding:14px 18px;border-bottom:1px solid var(--cal-line);background:var(--cal-panel)}.ccal-mode{display:flex;padding:3px;border:1px solid var(--cal-line2);border-radius:8px;background:var(--cal-soft)}.ccal-mode a{min-height:40px;display:grid;place-items:center;border-radius:5px;padding:0 14px;color:var(--cal-muted);font-size:14px;font-weight:900}.ccal-mode a.active{background:var(--cal-teal);color:var(--accent-ink)}.ccal-period{display:grid;grid-template-columns:44px minmax(0,1fr) 44px;align-items:center;max-width:460px;justify-self:center;width:100%}.ccal-period>a{width:44px;height:44px;display:grid;place-items:center;border:1px solid var(--cal-line2);border-radius:7px;color:var(--cal-ink);font-size:19px}.ccal-period-title{text-align:center}.ccal-period-title strong{display:block;font-size:15px}.ccal-period-title span{display:block;margin-top:3px;color:var(--cal-faint);font:750 14px var(--mono,monospace)}.ccal-draft-action{min-height:44px;display:inline-flex;align-items:center;justify-content:center;border:1px solid #355d59;border-radius:7px;background:var(--cal-panel);color:var(--cal-teal);padding:0 14px;font-size:14px;font-weight:900;cursor:pointer;text-decoration:none}.ccal-draft-action[disabled]{cursor:not-allowed;opacity:.76}.ccal-channelbar{display:flex;gap:7px;overflow-x:auto;padding:10px 18px;border-bottom:1px solid var(--cal-line);background:var(--cal-panel);scrollbar-width:thin}.ccal-channelbar a{min-height:40px;display:inline-flex;align-items:center;border:1px solid var(--cal-line2);border-radius:999px;padding:0 13px;color:var(--cal-muted);font-size:14px;font-weight:850;white-space:nowrap}.ccal-channelbar a.active{border-color:#2d897e;background:var(--cal-teal-soft);color:var(--cal-teal)}
  .ccal-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));border-bottom:1px solid var(--cal-line);background:var(--cal-panel)}.ccal-metric{min-width:0;padding:14px 18px;border-right:1px solid var(--cal-line)}.ccal-metric:last-child{border-right:0}.ccal-metric small{display:block;color:var(--cal-faint);font:800 14px var(--mono,monospace);letter-spacing:.06em;text-transform:uppercase}.ccal-metric strong{display:block;margin:6px 0 3px;font:900 22px/1 var(--mono,monospace)}.ccal-metric span{color:var(--cal-muted);font-size:14px}.ccal-metric.ready strong{color:var(--cal-teal)}.ccal-metric.blocked strong{color:var(--cal-amber)}
  .ccal-workspace{display:grid;grid-template-columns:minmax(0,1fr) minmax(285px,330px);gap:12px;padding:12px}.ccal-calendar,.ccal-backlog{min-width:0;border:1px solid var(--cal-line);background:var(--cal-panel)}.ccal-section-head{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;padding:14px 16px;border-bottom:1px solid var(--cal-line)}.ccal-section-head h2{margin:0;font-size:15px}.ccal-section-head p{margin:4px 0 0;color:var(--cal-muted);font-size:14px;line-height:1.45}.ccal-count{border:1px solid var(--cal-line2);padding:4px 8px;color:var(--cal-muted);font:850 14px var(--mono,monospace);white-space:nowrap}
  .ccal-scroll{max-width:100%;overflow-x:auto;scrollbar-color:var(--cal-line2) var(--cal-soft)}.ccal-weekdays{display:grid;grid-template-columns:repeat(7,minmax(155px,1fr));min-width:1085px;border-bottom:1px solid var(--cal-line);background:var(--cal-soft)}.ccal-weekday{padding:8px 10px;border-right:1px solid var(--cal-line);color:var(--cal-faint);font:800 14px var(--mono,monospace);letter-spacing:.06em;text-transform:uppercase}.ccal-weekday:last-child{border-right:0}.ccal-grid{display:grid;grid-template-columns:repeat(7,minmax(155px,1fr));min-width:1085px}.ccal-day{min-width:0;min-height:410px;border-right:1px solid var(--cal-line);background:var(--cal-panel)}.ccal-day:last-child{border-right:0}.ccal-day-head{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:10px;border-bottom:1px solid var(--cal-line)}.ccal-day-head strong{font:900 16px var(--mono,monospace)}.ccal-day-head span{color:var(--cal-faint);font-size:14px}.ccal-day.today .ccal-day-head{box-shadow:inset 0 -2px var(--cal-teal)}.ccal-day.today .ccal-day-head strong{color:var(--cal-teal)}.ccal-day.outside{opacity:.48}.ccal-day-slots{display:grid;gap:7px;padding:7px}.ccal-empty-day{min-height:74px;display:grid;place-items:center;border:1px dashed var(--cal-line);color:var(--cal-faint);font-size:14px;text-align:center;padding:8px}
  .ccal-slot{position:relative;min-width:0;border:1px solid var(--cal-line2);border-left:3px solid var(--cal-teal);border-radius:7px;background:var(--cal-raised);overflow:hidden}.ccal-slot.locked{border-left-color:var(--cal-amber)}.ccal-slot.attention{border-left-color:var(--cal-red);box-shadow:inset 0 0 0 1px rgba(255,115,107,.2)}.ccal-slot-top{display:flex;align-items:center;justify-content:space-between;gap:7px;padding:8px 9px;border-bottom:1px solid var(--cal-line)}.ccal-channel{display:inline-flex;align-items:center;gap:6px;min-width:0;color:var(--cal-muted);font-size:14px;font-weight:850}.ccal-channel-code{width:23px;height:23px;display:grid;place-items:center;border:1px solid currentColor;border-radius:5px;color:var(--cal-blue);font:900 14px var(--mono,monospace);text-transform:uppercase}.ccal-channel-code.instagram{color:#e38ad9}.ccal-channel-code.facebook{color:#91aeff}.ccal-channel-code.tiktok{color:#74f0e3}.ccal-channel-code.x{color:#e4e9eb}.ccal-channel-code.youtube{color:#ff8179}.ccal-channel-code.google-business{color:#78b5ff}.ccal-channel-code.threads{color:#d2d7d9}.ccal-channel-code.pinterest{color:#ff8b88}.ccal-channel-code.email{color:#e6c477}.ccal-channel-code.webinar{color:#bb92ff}.ccal-time{color:var(--cal-ink);font:900 14px var(--mono,monospace)}.ccal-slot-body{padding:9px}.ccal-slot-state{display:flex;gap:5px;flex-wrap:wrap;margin-bottom:7px}.ccal-chip{display:inline-flex;align-items:center;min-height:22px;border:1px solid var(--cal-line2);border-radius:999px;padding:2px 6px;color:var(--cal-faint);font:800 14px var(--mono,monospace);letter-spacing:.03em;text-transform:uppercase}.ccal-chip.test{border-color:#2d756d;background:var(--cal-teal-soft);color:var(--cal-teal)}.ccal-chip.durable.planned{border-color:#39716b;color:var(--cal-ink)}.ccal-chip.durable.working{border-color:#675b35;color:var(--cal-amber)}.ccal-chip.durable.complete{border-color:#357a61;color:var(--success)}.ccal-chip.durable.cancelled{border-color:#596369;color:var(--cal-ink)}.ccal-chip.durable.attention{border-color:#7b3f3b;background:var(--cal-panel);color:var(--danger)}.ccal-slot h3{margin:0;font-size:14px;line-height:1.4}.ccal-variant{margin:5px 0 0;color:var(--cal-muted);font-size:14px;line-height:1.4}.ccal-social-line{margin:7px 0 0;color:var(--cal-faint);font:800 14px/1.45 var(--mono,monospace)}.ccal-campaign-link{min-height:44px;display:inline-flex;align-items:center;margin-top:6px;color:var(--cal-teal);font-size:14px;font-weight:900}.ccal-campaign-link:focus-visible{outline:3px solid rgba(0,229,204,.3);outline-offset:2px}.ccal-gate{display:flex;align-items:center;gap:6px;margin-top:8px;color:var(--cal-teal);font-size:14px;font-weight:900}.ccal-gate::before{content:"";width:6px;height:6px;border-radius:50%;background:currentColor}.ccal-slot.locked .ccal-gate{color:var(--cal-amber)}.ccal-slot.attention .ccal-gate{color:var(--cal-red)}.ccal-slot details{border-top:1px solid var(--cal-line)}.ccal-slot summary{min-height:40px;display:flex;align-items:center;justify-content:space-between;gap:7px;list-style:none;padding:0 9px;color:var(--cal-faint);font:800 14px var(--mono,monospace);cursor:pointer;text-transform:uppercase}.ccal-slot summary::-webkit-details-marker{display:none}.ccal-slot summary::after{content:"+";color:var(--cal-teal);font-size:15px}.ccal-slot details[open] summary::after{content:"−"}.ccal-proof{display:grid;gap:6px;padding:0 9px 9px}.ccal-proof-row{display:grid;grid-template-columns:62px minmax(0,1fr);gap:5px;color:var(--cal-muted);font-size:14px;line-height:1.35}.ccal-proof-row span{color:var(--cal-faint)}.ccal-proof-row code{color:var(--cal-ink)}.ccal-proof-note{margin:2px 0 0;color:var(--cal-muted);font-size:14px;line-height:1.45}.ccal-social-proof{display:grid;gap:6px;margin-top:3px;padding-top:8px;border-top:1px dashed var(--cal-line2)}.ccal-social-proof>strong{color:var(--cal-teal);font-size:14px}.ccal-social-proof.attention>strong{color:var(--cal-red)}
  .ccal-live-slot{border-color:#2f776f;border-left-color:var(--cal-teal);background:linear-gradient(145deg,var(--cal-teal-soft),var(--cal-panel))}.ccal-live-slot.working{border-left-color:var(--cal-amber)}.ccal-live-slot.attention{border-left-color:var(--cal-red)}.ccal-live-slot.cancelled{border-left-color:var(--cal-faint);opacity:.72}.ccal-chip.live{border-color:#2d897e;background:var(--cal-teal-soft);color:var(--cal-teal)}.ccal-chip.live.working{border-color:#675b35;color:var(--cal-amber)}.ccal-chip.live.attention{border-color:#7b3f3b;background:var(--cal-panel);color:var(--danger)}.ccal-chip.live.cancelled{border-color:#596369;color:var(--cal-ink)}
  .ccal-slot-move{display:none;grid-template-columns:44px minmax(0,1fr);gap:6px;padding:7px 8px;border-top:1px solid var(--cal-line);background:var(--cal-soft)}.ccal-enhanced .ccal-slot-move{display:grid}.ccal-move-handle,.ccal-move-sheet-button{min-height:44px;border:1px solid var(--cal-line2);border-radius:6px;background:var(--cal-panel);color:var(--cal-muted);font-size:14px;font-weight:900}.ccal-move-handle{min-width:44px;padding:0;color:var(--cal-teal);font:900 15px var(--mono,monospace);cursor:grab;touch-action:none}.ccal-move-handle[aria-pressed="true"]{cursor:grabbing;background:var(--cal-teal-soft);box-shadow:inset 0 0 0 2px var(--cal-teal)}.ccal-move-sheet-button{padding:0 9px}.ccal-move-handle:focus-visible,.ccal-move-sheet-button:focus-visible,.ccal-sheet-button:focus-visible{outline:3px solid rgba(0,229,204,.3);outline-offset:2px}.ccal-slot[data-preview-moving="true"]{opacity:.76;box-shadow:0 0 0 2px var(--cal-teal)}.ccal-day[data-preview-drop-target="true"]{background:var(--cal-panel);box-shadow:inset 0 0 0 2px var(--cal-teal)}.ccal-local-truth{display:flex;align-items:center;justify-content:space-between;gap:14px;margin:0 12px 12px;padding:10px 12px;border:1px solid #2f6963;background:var(--cal-panel);color:var(--cal-muted);font-size:14px;line-height:1.5}.ccal-local-truth strong{color:var(--cal-teal)}.ccal-local-truth span:last-child{color:var(--cal-faint);font:800 14px var(--mono,monospace);white-space:nowrap}.ccal[data-preview-dirty="true"] .ccal-local-truth{border-color:var(--cal-amber)}.ccal[data-preview-dirty="true"] .ccal-local-truth strong{color:var(--cal-amber)}
  .ccal-move-sheet[hidden]{display:none!important}.ccal-move-sheet{position:fixed;z-index:1000;inset:0;display:grid;place-items:end center;padding:18px;background:rgba(0,0,0,.72)}.ccal-move-sheet-panel{width:min(100%,480px);border:1px solid var(--cal-line2);border-radius:13px;background:var(--cal-panel);box-shadow:0 25px 80px rgba(0,0,0,.55);padding:18px}.ccal-move-sheet-panel h2{margin:0;font-size:18px}.ccal-move-sheet-panel>p{margin:6px 0 15px;color:var(--cal-muted);font-size:14px;line-height:1.5}.ccal-sheet-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.ccal-sheet-grid label{display:grid;gap:6px;color:var(--cal-muted);font-size:14px;font-weight:850}.ccal-sheet-grid input{width:100%;min-height:46px;border:1px solid var(--cal-line2);border-radius:7px;background:var(--cal-panel);color:var(--cal-ink);padding:8px 10px;font:800 14px var(--mono,monospace);color-scheme:dark}.ccal-sheet-actions{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:14px}.ccal-sheet-button{min-height:46px;border:1px solid var(--cal-line2);border-radius:7px;background:var(--cal-panel);color:var(--cal-muted);font-size:14px;font-weight:900}.ccal-sheet-button.primary{border-color:#337a72;background:var(--cal-panel);color:var(--cal-teal)}.ccal-live{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
  .ccal-grid.month .ccal-day{min-height:160px}.ccal-grid.month .ccal-day-head{padding:7px 8px}.ccal-grid.month .ccal-day-head span{display:none}.ccal-grid.month .ccal-day-slots{gap:4px;padding:5px}.ccal-grid.month .ccal-slot-top{padding:5px 6px}.ccal-grid.month .ccal-channel span:last-child,.ccal-grid.month .ccal-variant,.ccal-grid.month .ccal-social-line,.ccal-grid.month .ccal-slot details{display:none}.ccal-grid.month .ccal-slot-state .ccal-chip:not(.durable){display:none}.ccal-grid.month .ccal-slot-body{padding:6px}.ccal-grid.month .ccal-slot h3{display:-webkit-box;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:2}.ccal-grid.month .ccal-gate{margin-top:5px}.ccal-grid.month .ccal-empty-day{min-height:55px;border:0}.ccal-grid.month .ccal-slot-move{grid-template-columns:44px 1fr;padding:5px}.ccal-grid.month .ccal-move-sheet-button{font-size:14px}
  .ccal-backlog{align-self:start}.ccal-backlog-list{list-style:none;display:grid;gap:0;margin:0;padding:0}.ccal-backlog-item{padding:12px 13px;border-bottom:1px solid var(--cal-line)}.ccal-backlog-item:last-child{border-bottom:0}.ccal-backlog-meta{display:flex;gap:5px;flex-wrap:wrap;margin-bottom:7px}.ccal-backlog h3{margin:0;font-size:14px;line-height:1.4}.ccal-backlog-proof{display:grid;grid-template-columns:1fr 1fr;gap:5px;margin-top:8px}.ccal-backlog-proof span{color:var(--cal-faint);font-size:14px}.ccal-backlog-proof strong{display:block;margin-top:2px;color:var(--cal-muted);font-size:14px}.ccal-backlog-gate{margin:8px 0 0;color:var(--cal-muted);font-size:14px;line-height:1.45}.ccal-sim-action{width:100%;min-height:44px;margin-top:9px;border:1px solid var(--cal-line2);border-radius:6px;background:var(--cal-soft);color:var(--cal-faint);font-size:14px;font-weight:900;cursor:not-allowed}.ccal-empty-backlog{padding:25px 17px;text-align:center;color:var(--cal-muted);font-size:14px;line-height:1.55}.ccal-backlog-note{margin:0;padding:11px 13px;border-top:1px solid var(--cal-line);background:var(--cal-soft);color:var(--cal-faint);font-size:14px;line-height:1.5}
  .ccal-warning{margin:0 12px 12px;border:1px solid #6f5a2c;background:var(--cal-panel);padding:10px 12px;color:var(--cal-amber);font-size:14px;line-height:1.5}.ccal-footer{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;padding:13px 18px;border-top:1px solid var(--cal-line);background:var(--cal-panel);color:var(--cal-faint);font-size:14px;line-height:1.5}.ccal-footer strong{color:var(--cal-muted)}
  .ccal-outcome{margin:12px 12px 0;border:1px solid #33766e;border-left:4px solid var(--cal-teal);background:var(--cal-panel);padding:11px 13px}.ccal-outcome[data-kind="info"]{border-color:#6f5b30;border-left-color:var(--cal-amber);background:var(--cal-panel)}.ccal-outcome[data-kind="error"]{border-color:#7a413d;border-left-color:var(--cal-red);background:var(--cal-panel)}.ccal-outcome strong{display:block;font-size:14px}.ccal-outcome p{margin:4px 0 0;color:var(--cal-muted);font-size:14px;line-height:1.5}.ccal-outcome code{display:block;margin-top:6px;color:var(--cal-faint);font:750 14px var(--mono,monospace);overflow-wrap:anywhere}.ccal-outcome[data-jit-loading="true"]{border-left-color:var(--cal-blue)}
  .ccal-create{position:relative;justify-self:end}.ccal-create>summary{min-height:44px;display:flex;align-items:center;justify-content:center;border:1px solid #347a72;border-radius:7px;background:var(--cal-panel);color:var(--cal-teal);padding:0 14px;font-size:14px;font-weight:900;cursor:pointer;list-style:none}.ccal-create>summary::-webkit-details-marker{display:none}.ccal-create[open]>summary{box-shadow:0 0 0 3px rgba(0,229,204,.12)}.ccal-create-panel{position:absolute;z-index:40;top:calc(100% + 8px);right:0;width:min(520px,calc(100vw - 36px));border:1px solid var(--cal-line2);border-radius:11px;background:var(--cal-panel);box-shadow:0 24px 70px rgba(0,0,0,.55);padding:15px}.ccal-create-panel h2{margin:0 0 4px;font-size:15px}.ccal-create-panel>p{margin:0 0 12px;color:var(--cal-muted);font-size:14px;line-height:1.5}
  .ccal-command-form{display:grid;gap:9px}.ccal-command-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.ccal-command-field{display:grid;gap:5px;color:var(--cal-muted);font-size:14px;font-weight:850}.ccal-command-field.wide{grid-column:1/-1}.ccal-command-field input,.ccal-command-field select,.ccal-command-field textarea{width:100%;min-height:44px;border:1px solid var(--cal-line2);border-radius:6px;background:var(--cal-panel);color:var(--cal-ink);padding:8px 9px}.ccal-command-field textarea{min-height:64px;resize:vertical;line-height:1.45}.ccal-command-field input:focus,.ccal-command-field select:focus,.ccal-command-field textarea:focus{border-color:var(--cal-teal);box-shadow:0 0 0 3px rgba(0,229,204,.12);outline:0}.ccal-command-confirm{display:grid;grid-template-columns:20px 1fr;gap:7px;align-items:start;color:var(--cal-muted);font-size:14px;line-height:1.45}.ccal-command-confirm input{width:18px;height:18px;margin:0;accent-color:var(--cal-teal)}.ccal-command-submit{min-height:44px;border:1px solid #337a72;border-radius:6px;background:var(--cal-panel);color:var(--cal-teal);padding:0 11px;font-size:14px;font-weight:900;cursor:pointer}.ccal-command-submit.danger{border-color:#78413d;background:var(--cal-panel);color:var(--cal-red)}.ccal-command-submit[disabled],.ccal-command-form[aria-busy="true"] .ccal-command-submit{opacity:.58;cursor:wait}.ccal-command-status{min-height:1.45em;margin:0;color:var(--cal-faint);font-size:14px;line-height:1.45}
  .ccal-operations{border-top:1px solid var(--cal-line);background:var(--cal-panel)}.ccal-operations>summary{min-height:42px;display:flex;align-items:center;justify-content:space-between;list-style:none;padding:0 9px;color:var(--cal-teal);font:850 14px var(--mono,monospace);cursor:pointer;text-transform:uppercase}.ccal-operations>summary::-webkit-details-marker{display:none}.ccal-operations>summary::after{content:"+";font-size:15px}.ccal-operations[open]>summary::after{content:"−"}.ccal-operation-body{display:grid;gap:10px;padding:0 9px 10px}.ccal-jit{border:1px solid var(--cal-line2);border-left:3px solid var(--cal-teal);background:var(--cal-panel);padding:8px}.ccal-jit[data-state="due"],.ccal-jit[data-state="blocked"]{border-left-color:var(--cal-amber)}.ccal-jit[data-state="cancelled"]{border-left-color:var(--cal-faint)}.ccal-jit strong{display:block;font-size:14px}.ccal-jit p{margin:3px 0 0;color:var(--cal-muted);font-size:14px;line-height:1.45}.ccal-jit time{display:block;margin-top:4px;color:var(--cal-faint);font:700 14px var(--mono,monospace)}.ccal-operation-separator{border:0;border-top:1px solid var(--cal-line);margin:2px 0}.ccal-slot[data-command-state="saving"]{opacity:.72;box-shadow:0 0 0 2px var(--cal-blue)}.ccal-slot[data-command-state="saved"]{box-shadow:0 0 0 2px var(--cal-teal)}.ccal-slot[data-command-state="error"]{box-shadow:0 0 0 2px var(--cal-red)}
  ...
  html[data-theme="light"] .ccal-hero{background:radial-gradient(circle at 79% -15%,var(--accent-soft),transparent 36%),linear-gradient(135deg,var(--panel),var(--panel-subtle) 67%)}html[data-theme="light"] .ccal-test-card,html[data-theme="light"] .ccal-safety,html[data-theme="light"] .ccal-channelbar,html[data-theme="light"] .ccal-day{background:var(--panel-subtle)}html[data-theme="light"] .ccal-toolbar,html[data-theme="light"] .ccal-metrics,html[data-theme="light"] .ccal-calendar,html[data-theme="light"] .ccal-backlog{background:var(--panel)}
  @media(prefers-color-scheme:light){html[data-theme="system"] .ccal-hero{background:radial-gradient(circle at 79% -15%,var(--accent-soft),transparent 36%),linear-gradient(135deg,var(--panel),var(--panel-subtle) 67%)}html[data-theme="system"] .ccal-test-card,html[data-theme="system"] .ccal-safety,html[data-theme="system"] .ccal-channelbar,html[data-theme="system"] .ccal-day{background:var(--panel-subtle)}html[data-theme="system"] .ccal-toolbar,html[data-theme="system"] .ccal-metrics,html[data-theme="system"] .ccal-calendar,html[data-theme="system"] .ccal-backlog{background:var(--panel)}}
  @media(prefers-reduced-motion:reduce){.ccal *{scroll-behavior:auto!important;transition:none!important}}
  .ccal-live-scheduler{margin:12px;border:1px solid #337a72;background:var(--cal-panel);padding:clamp(16px,2.2vw,26px);box-shadow:inset 0 1px rgba(255,255,255,.03),0 18px 55px rgba(0,0,0,.28)}.ccal-live-scheduler-grid{display:grid;grid-template-columns:minmax(0,1.12fr) minmax(280px,.72fr);gap:24px}.ccal-live-scheduler h2{margin:0;font-size:clamp(20px,2.2vw,28px);letter-spacing:-.025em}.ccal-live-scheduler header p{margin:7px 0 18px;color:var(--cal-muted);font-size:14px;line-height:1.55}.ccal-live-list{list-style:none;margin:0;padding:0;border:1px solid var(--cal-line)}.ccal-live-list li{padding:10px;border-bottom:1px solid var(--cal-line)}.ccal-live-list li:last-child{border-bottom:0}.ccal-live-list strong{display:block;font-size:14px}.ccal-live-list p{margin:5px 0;color:var(--cal-muted);font-size:14px;line-height:1.4}.ccal-live-list time{color:var(--cal-teal);font:800 14px var(--mono,monospace)}
  @media(max-width:800px){.ccal-live-scheduler-grid{grid-template-columns:1fr}}
  .ccal-live-workflow{display:grid;gap:10px;margin:14px 0 0;padding:0;list-style:none;counter-reset:live-step}.ccal-live-workflow li{counter-increment:live-step;display:grid;grid-template-columns:30px minmax(0,1fr);gap:9px;align-items:start;color:var(--cal-muted);font-size:14px;line-height:1.45}.ccal-live-workflow li::before{content:counter(live-step);width:30px;height:30px;display:grid;place-items:center;border:1px solid #337a72;border-radius:50%;color:var(--cal-teal);font:900 14px var(--mono,monospace)}.ccal-live-workflow strong{display:block;color:var(--cal-ink);font-size:14px}.ccal-live-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:15px}.ccal-live-actions a{min-height:44px;display:inline-flex;align-items:center;border:1px solid #337a72;border-radius:7px;background:var(--cal-panel);color:var(--cal-teal);padding:0 13px;font-size:14px;font-weight:900}.ccal-live-actions a.secondary{border-color:var(--cal-line2);background:var(--cal-panel);color:var(--cal-muted)}.ccal-live-boundary{margin:13px 0 0;border-left:3px solid var(--cal-teal);background:var(--cal-panel);padding:10px 12px;color:var(--cal-muted);font-size:14px;line-height:1.5}.ccal-live-boundary strong{color:var(--cal-teal)}.ccal-live-read-state{border:1px solid var(--cal-line2);background:var(--cal-panel);padding:12px;color:var(--cal-muted);font-size:14px;line-height:1.5}.ccal-live-read-state.attention{border-color:#675b35;color:var(--cal-amber)}.ccal-live-networks{display:flex;gap:6px;flex-wrap:wrap;margin:0 0 10px}.ccal-live-network{border:1px solid #2d897e;border-radius:999px;background:var(--cal-teal-soft);color:var(--cal-teal);padding:4px 8px;font:800 14px var(--mono,monospace);text-transform:uppercase}

  .ccal-support{margin:12px;padding:14px;border:1px solid var(--cal-line);background:var(--cal-panel)}.ccal-support>summary{cursor:pointer;font-size:1rem;font-weight:700;color:var(--cal-muted)}.ccal-backlog-item details{margin-top:8px}.ccal-backlog-item summary{cursor:pointer;color:var(--cal-muted)}
  /* Readability is shared with HQ; compact calendar metadata remains at least 14px. */
  html[data-theme] .ccal p,html[data-theme] .ccal label,html[data-theme] .ccal input,html[data-theme] .ccal select,html[data-theme] .ccal textarea,html[data-theme] .ccal-live-workflow li,html[data-theme] .ccal-live-workflow strong{font-size:1rem;line-height:1.55}
  .ccal button,.ccal-create>summary,.ccal-live-actions a{font-size:1rem}
  .ccal-slot h3,.ccal-backlog h3{font-size:1rem;line-height:1.5}
  .ccal-live-slot.cancelled{opacity:1}
`;
...
function operationOutcome(view: ContentCalendarOperationOutcomeView | undefined): string {
  if (!view) return '';
  if (view.title === 'Durable TEST campaign planned' || view.title === 'Safe replay confirmed') {
    return '<aside class="ccal-outcome" data-kind="success" role="status"><strong>Plan saved</strong><p>Nothing has been published. Find your post on the calendar below, then choose Confirm publishing when you are ready. If it needs attention, open the post to see what is missing.</p></aside>';
  }
...
function liveScheduleCard(item: ContentCalendarLiveScheduleView, timezone: string): string {
  ...
  if (!instant) return '';
  const channelLabel = item.network === 'instagram' ? 'Instagram' : 'LinkedIn';
  const channelCode = item.network === 'instagram' ? 'ig' : 'in';
  const summary = safeOperationText(item.content, `Scheduled ${channelLabel} post`, 12_000);
  const short = summary.length > 150 ? `${summary.slice(0, 147)}…` : summary;
  const state = item.state === 'queued'
    ? Object.freeze({ label: 'Queued for worker', tone: 'ready' })
    : item.state === 'leased'
      ? Object.freeze({ label: 'Worker preparing', tone: 'working' })
      : item.state === 'calling'
        ? Object.freeze({ label: 'Publishing', tone: 'working' })
        : item.state === 'reconciliation_pending'
          ? Object.freeze({ label: 'Checking provider', tone: 'working' })
          : item.state === 'succeeded'
            ? Object.freeze({ label: 'Published', tone: 'ready' })
      : item.state === 'cancelled'
        ? Object.freeze({ label: 'Cancelled', tone: 'cancelled' })
        : item.state === 'failed'
          ? Object.freeze({ label: 'Failed', tone: 'attention' })
          : Object.freeze({ label: 'Needs attention', tone: 'attention' });
  return `<article class="ccal-slot ccal-live-slot ${state.tone}" aria-label="Worker-backed ${channelLabel} job at ${escapeHtml(instant.time)}" data-calendar-live-slot data-job-id="${escapeHtml(item.jobId)}" data-scheduled-for="${escapeHtml(item.scheduledFor)}"><header class="ccal-slot-top"><span class="ccal-channel"><span class="ccal-channel-code ${escapeHtml(item.network)}" aria-hidden="true">${channelCode}</span><span>${channelLabel}</span></span><time class="ccal-time" datetime="${escapeHtml(item.scheduledFor)}">${escapeHtml(instant.time)}</time></header><div class="ccal-slot-body"><div class="ccal-slot-state"><span class="ccal-chip live ${escapeHtml(state.tone)}">${escapeHtml(state.label)}</span></div><h3>${escapeHtml(short)}</h3><p class="ccal-variant">Approval-gated worker job · ${escapeHtml(timezone)}</p></div></article>`;
}
...
export interface RenderContentCalendarOptions {
  ...
  readonly desiredForLocal?: string;
  readonly postPlan?: ContentCalendarPostPlanView;
}

export interface ContentCalendarPostPlanView extends ContentCalendarCommandActionView {
  readonly contentVersions: readonly ContentCalendarChoiceView[];
  readonly targets: readonly ContentCalendarChoiceView[];
}
...
function planPost(view: ContentCalendarView, options: RenderContentCalendarOptions): string {
  ...
  return `<section class="ccal-live-scheduler" id="new-plan" aria-labelledby="ccal-plan-title"><h2 id="ccal-plan-title">Plan your post</h2><p>Choose an account and a time. Saving prepares your post; you will confirm publishing separately.</p><form class="ccal-command-form" method="post" action="${escapeHtml(plan.actionUrl)}" data-calendar-post-plan>${actionFields(plan)}${hidden('confirm_test_only', 'confirmed')}${hidden('environment', 'test')}${hidden('timezone', view.timezone)}${hidden('return_to', CONTENT_CALENDAR_ROUTE)}${hidden('title', 'Social post')}${hidden('objective', 'Prepare the selected approved post for the chosen account and time.')}${hidden('max_attempts', '1')}<div class="ccal-command-grid"><label class="ccal-command-field wide">Your approved post<select name="content_version_id" required><option value="">Choose a post</option>${choiceOptions(plan.contentVersions, selected)}</select></label><label class="ccal-command-field">Where should it appear?<select name="target_ids" required><option value="">Choose an account</option>${choiceOptions(plan.targets, options.selectedTargetId)}</select></label><label class="ccal-command-field">Date and time<input type="datetime-local" name="desired_for_local" value="${escapeHtml(options.desiredForLocal ?? '')}" step="60" required><span>${escapeHtml(view.timezone === 'Europe/London' ? 'UK time' : view.timezone)}</span></label></div><p>Saving does not publish your post.</p><button class="ccal-command-submit" type="submit">Save plan</button></form></section>`;
}

function yourPosts(view: ContentCalendarView, options: RenderContentCalendarOptions): string {
...
function scheduledPosts(projection: ContentCalendarLiveScheduleProjectionView | undefined, timezone: string): string {
  const labels: Record<ContentCalendarLiveScheduleView['state'], string> = {
    queued: 'Scheduled', leased: 'Preparing to publish', calling: 'Publishing',
    reconciliation_pending: 'Checking publication', succeeded: 'Published', failed: 'Could not publish',
    needs_attention: 'Needs attention', cancelled: 'Cancelled',
  };
  const items = projection?.status === 'ready' ? projection.items.slice(0, 20).map(item =>
    `<li><strong>${item.network === 'linkedin' ? 'LinkedIn' : 'Instagram'} · ${labels[item.state]}</strong><p>${escapeHtml(safeOperationText(item.content, 'Social post', 180))}</p>${zonedScheduleInstant(item.scheduledFor, timezone)?.markup ?? 'Time unavailable'}</li>`).join('') : '';
  return `<section class="ccal-live-scheduler"><h2>Scheduled posts</h2>${items ? `<ol class="ccal-live-list">${items}</ol>` : `<p>${projection?.status === 'ready' ? 'Nothing scheduled for this period yet. Saved plans still need your publishing confirmation.' : 'We cannot show your scheduled posts right now. Nothing has been changed.'}</p>`}</section>`;
}

function liveScheduler(
  projection: ContentCalendarLiveScheduleProjectionView | undefined,
  timezone: string,
): string {
  const ready = projection?.status === 'ready';
  const configured = projection?.configuredNetworks ?? [];
  const networkLabels = configured.map((network) => (
    `<span class="ccal-live-network">${network === 'instagram' ? 'Instagram' : 'LinkedIn'}</span>`
  )).join('');
  const activation = commandReady(projection?.activation)
    ? `<form class="ccal-command-form" method="post" action="${escapeHtml(projection.activation.actionUrl)}"><input type="hidden" name="_csrf" value="${escapeHtml(projection.activation.csrfToken)}"><input type="hidden" name="command_key" value="${escapeHtml(projection.activation.commandKey)}"><label class="ccal-command-confirm"><input type="checkbox" name="confirm_foundation" value="confirmed" required><span>Create only the deterministic TEST planning targets for the connected company accounts. No post is queued or sent.</span></label><button class="ccal-command-submit" type="submit">Activate safe calendar foundation</button></form>`
    : '';
  const items = ready ? projection.items.slice(0, 20).map((item) => {
    const channel = item.network === 'instagram' ? 'Instagram' : 'LinkedIn';
    const summary = safeOperationText(item.content, `Scheduled ${channel} post`, 12_000);
    const short = summary.length > 180 ? `${summary.slice(0, 177)}…` : summary;
    const instant = zonedScheduleInstant(item.scheduledFor, timezone);
    const label = item.state === 'queued' ? 'Queued for worker'
      : item.state === 'leased' ? 'Worker preparing'
        : item.state === 'calling' ? 'Publishing'
          : item.state === 'reconciliation_pending' ? 'Checking provider'
            : item.state === 'succeeded' ? 'Published'
              : item.state === 'needs_attention' ? 'Needs attention'
                : item.state[0]?.toUpperCase() + item.state.slice(1);
    return `<li><strong>${escapeHtml(channel)} · ${escapeHtml(label)}</strong><p>${escapeHtml(short)}</p>${instant?.markup ?? 'Schedule time unavailable'}</li>`;
  }).join('') : '';
  const readState = !projection
    ? '<p class="ccal-live-read-state attention"><strong>Live calendar foundation is not configured.</strong><br>You can still create, review and plan content. No provider call is available from this page.</p>'
    : projection.status === 'unavailable'
      ? '<p class="ccal-live-read-state attention"><strong>Worker schedule state is temporarily unavailable.</strong><br>Existing jobs were not changed and no provider call was made.</p>'
      : items
        ? `<ol class="ccal-live-list">${items}</ol>`
        : '<p class="ccal-live-read-state"><strong>No worker-backed jobs in this window.</strong><br>Approve and plan content first; staged jobs will appear here.</p>';
  return `<section class="ccal-live-scheduler" aria-labelledby="ccal-live-title"><div class="ccal-live-scheduler-grid"><div><header><span class="ccal-kicker">Approval-gated publishing</span><h2 id="ccal-live-title">Create → approve → plan → stage</h2><p>The calendar is a safe control surface. It never sends raw copy or media straight to a provider.</p></header><ol class="ccal-live-workflow"><li><span><strong>Create channel-ready drafts</strong>Turn one owned source into native LinkedIn and Instagram versions.</span></li><li><span><strong>Approve the exact immutable version</strong>Review the final words, source proof and media before anything can move.</span></li><li><span><strong>Plan the exact time, then stage</strong>An approved calendar card exposes “Schedule live on …”. Staging records a capped job; the dedicated worker publishes it.</span></li></ol><div class="ccal-live-actions"><a href="${CAMPAIGN_WIZARD_ROUTE}">Create channel drafts</a><a class="secondary" href="${CONTENT_CONTROL_ROOM_ROUTE}">Review &amp; approve</a><a class="secondary" href="${PUBLIC_SOCIAL_CAMPAIGNS_ROUTE}">Plan campaign time</a></div>${activation}<p class="ccal-live-boundary"><strong>Safe boundary:</strong> this page can only read worker state or take you to the separate evidence-bound staging review. It cannot call the social provider.</p></div><div><header><h2>Worker-backed schedules</h2><p>Instagram and LinkedIn jobs already staged through exact approval evidence.</p></header>${networkLabels ? `<div class="ccal-live-networks" aria-label="Configured publishing networks">${networkLabels}</div>` : ''}${readState}</div></div></section>`;
}
...
export function renderContentCalendarBody(
  ...
  const live = options.liveSchedules?.status === 'ready';
  const configuredNetworks = options.liveSchedules?.configuredNetworks ?? [];
  const liveItems = live
    ? options.liveSchedules.items.slice(0, 100).filter((item) => (
      view.filters.channel === 'all' || view.filters.channel === item.network
    ))
    : [];
  ...
  return `${renderContentWorkspaceNavigation('calendar', {
    ...
    ${channelNav(view)}
    <details class="ccal-support"><summary>Support details</summary><section class="ccal-metrics" aria-label="${loaded}planner summary"><div class="ccal-metric"><small>${loaded}draft placements</small><strong>${safeCount(view.metrics.plannedSlots)}</strong><span>No provider jobs created</span></div><div class="ccal-metric ready"><small>${loaded}simulation ready</small><strong>${safeCount(view.metrics.simulationReady)}</strong><span>Exact gates agree</span></div><div class="ccal-metric blocked"><small>${loaded}gate locked</small><strong>${safeCount(view.metrics.blocked)}</strong><span>Fails closed before outbound</span></div><div class="ccal-metric"><small>${loaded}active rails</small><strong>${safeCount(view.metrics.activeChannels)}</strong><span>Planning variants only</span></div></section>${backlog(view)}${liveScheduler(options.liveSchedules, view.timezone)}${createCalendarControl(options.mutations?.create, view.timezone)}</details>
    <div class="ccal-workspace"><section class="ccal-calendar" aria-labelledby="ccal-calendar-title"><header class="ccal-section-head"><div><h2 id="ccal-calendar-title">${view.filters.mode === 'week' ? 'This week' : 'This month'}</h2><p>Saved plans are not scheduled until you confirm publishing. Scroll sideways to see every day.</p></div><span class="ccal-count">${safeCount(liveVisibleCount)} delivery records · ${safeCount(view.visibleSlotCount)} plans</span></header><div class="ccal-scroll" tabindex="0" aria-label="Scrollable ${escapeHtml(view.filters.mode)} content calendar"><div class="ccal-weekdays" aria-hidden="true">${weekdays}</div><div class="ccal-grid ${escapeHtml(view.filters.mode)}">${days}</div></div></section>${yourPosts(view, options)}</div>
    <details class="ccal-support"><summary>Advanced plan controls</summary><aside class="ccal-local-truth" role="status"><span><strong>${durableControls ? 'Protected TEST commands available.' : 'Browser-only movement.'}</strong> Drag, use the keyboard handle or choose a date and time. ${durableControls ? 'Durable slots open confirmation before saving; unavailable slots remain local previews.' : 'Nothing is saved; reloading restores this exact snapshot.'}</span><span>TEST plan · zero external effects</span></aside></details>
    ${warning}
    ...
    <details class="ccal-support"><summary>About this calendar</summary><footer class="ccal-footer"><span>${live ? '<strong>Two clear truths:</strong> worker cards are read-only job evidence; TEST cards remain simulated and cannot publish.' : '<strong>Draft/simulated throughout:</strong> no posts, messages, webinar registrations or provider schedules are created here.'}${escapeHtml(bounded)}</span><span>${safeCount(view.catalogCount)} owned catalogue versions inspected · generated output: 0</span></footer></details>
